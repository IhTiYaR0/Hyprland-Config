...
set hidden
set showtabline=2     " всегда показывать табы
set tabpagemax=20
...
require("bufferline").setup{
  options = {
    mode = "buffers",              -- можно "tabs" для табов Vim
    numbers = "none",             -- можно "ordinal" или "buffer_id"
    indicator = { style = "underline" },
    separator_style = "slant",     -- или "slant", "thick"
...
" Закрывать Neovim, если остался только NERDTree
autocmd bufenter * if (winnr("$") == 1 && getbufvar(winbufnr(0), "&filetype") == "nerdtree") | q | endi
